...
extern PID_Number PID_Speed_Control_Num[8];
extern PID_Number PID_Position_Control_Num[8];
...
extern void Tuner_Control_Init();
extern void Current_Position_Control(uint8_t ID_Num, float Set_Angle);
